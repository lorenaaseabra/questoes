...
for i in frases:
    ...
    for palavra in lista_ruins:
        if palavra.title() in i:
            ruim += arq.count(palavra)  # contar a ocorrencia de palavras ruins no texto
            if palavra.title() not in reconhecidas:
                reconhecidas.append(palavra)  # contar as palavras ruins reconhecidas
    reconhecidas_frase.append(reconhecidas)  # separar as palavras reconhecidas de cada frase diferente
...
for i in frases:
    ...
    aprendidas_frase.append(aprendidas)  # lista com as palavras aprendidas de cada frase
    aprendidas = []
    index += 1
